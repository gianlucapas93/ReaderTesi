...
//
        ...
        String VA=pathGeneral+"VA\\"+"2016-VA.csv"; paths.add(VA);   //sono i file
        String VS=pathGeneral+"VS\\"+"2016-VS.csv"; paths.add(VS);
        String NA=pathGeneral+"NA\\"+"2016-NA.csv";paths.add(NA);
